...
<body class="font-inter">
    ...
    <form action="">
        ...
        <section class="flex flex-row justify-center gap-24 mt-24">
            <a class="w-52 h-16 bg-[#FF6060] text-white text-2xl rounded-xl flex font-semibold justify-center items-center"
                href="">Back</a>
            <button
                class="w-52 h-16 bg-[#FF6060] text-white text-2xl rounded-xl flex font-semibold justify-center items-center"
