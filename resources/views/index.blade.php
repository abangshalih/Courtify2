...
<body>
    <div class="iphone-8-23">
        ...
        <a href="#"><button type="submit"><img class="iphone-8-23-child" alt=""
                    src="images/ayamrica@2x.png" /></button></a>
        ...
        <a href="#"><button type="submit"><img class="iphone-8-23-item" alt=""
                    src="images/ayammadu@2x.png" /></button></a>
        ...
        <a href="#"><button type="submit"><img class="iphone-8-23-inner" alt=""
                    src="images/ayamgoreng@2x.png" /></button></a>

        <h4 class="rp-20000" id="harga1">Rp. 20.000</h4>
        <a href="punyadexter2" style="color: black;">
            <h4 class="ayam-bakar" id="menu1">Ayam Bakar</h4>
        </a>
        <a href="punyadexter2"><button type="submit"><img class="rectangle-icon" alt=""
                    src="images/ayambakar@2x.png" /></button></a>

        <img class="iphone-8-23-child1" alt="" loading="eager" src="images/bgAyam@2x.png" />
