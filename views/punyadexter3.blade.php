...
<body class="bg-slate-100">
    <div class="max-w-xl bg-[#fffff9] w-full h-screen">
        <div class="rounded-t-lg mx-auto bg-slate-300 mt-8 w-full h-screen mb-3">
            <div class="flex flex-col w-full">
                <div class="flex flex-col  justify-center items-center w-full mt-4">
                    ...
                    <body class="bg-slate-100">
                        <div class="max-w-xl mx-auto w-full h-screen">
                            <div class="flex flex-col w-full">
                                <img src="images/mandiri.png" class="px-4 mt-2 w-25" alt="" />

                                <body class="bg-slate-100">
                                    <div class="rounded-t-lg mx-auto bg-slate-300 w-full h-screen mb-3">
                                        <div class="flex flex-col w-full">
                                            <div class="flex flex-col  justify-center items-center w-full mt-4">
                                                <div
                                                ...
                                                <div class="container rounded w-11/12 h-10 flex flex-col justify-center item-center bg-white text-black font-bold text-xl mt-3">
                                                ...
                                                <div class="rounded-t-lg mx-auto bg-slate-300 mt-8 w-full h-screen mb-3">
                                                    <div class="flex flex-col w-full">
                                                        <div class="flex flex-col  justify-center items-center w-full">
                                                            ...
                                                            <div
                                                                class="rounded-t-lg mx-auto bg-slate-300 mt-2 w-full h-screen mb-3 ">
                                                                <div class="flex flex-col w-full">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="rounded-t-lg mx-auto bg-slate-300 mt-2 w-full h-screen mb-3 mb-10">
                                                                            <div class="flex flex-col w-full">
                                                                                <div
                                                                                    class="flex flex-col  justify-center items-center w-full">
                                                                                    <div
                                                                                    ...
                                                                                    <div
                                                                                        class="rounded-t-lg mx-auto bg-slate-300 mt-0.1 w-full h-screen mb-3 mb-10">
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <a class="w-11/12 h-10 items-center text-center bg-red-500 text-white font-semibold text-2xl mt-12" href="punyadexter4"><button
