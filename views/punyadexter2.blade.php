        ...
        <div class="max-w-xl mx-auto bg-[#fffff9] w-full min-h-screen ">
            <div class="flex flex-col w-full">
                ...
                <div class="flex flex-col justify-center items-center px-4 w-full mt-4 ">
                    ...
                    <p class="mt-6 text-justify">Ayam yang dibakar dengan bumbu rempah yang khas dilengkapi dengan lalapan ( Selada, Tomat). Lezat dan menyehatkan    </p>
                </div>
                ...
                <form class="flex flex-col px-4">
                    ...
                    <a href="punyadexter"><button class="w-full h-10 items-center text-center bg-red-500 text-white font-bold text-2xl mt-12" type="submit">Add to Basket - 20.000</button></a>
